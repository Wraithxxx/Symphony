...
import io.github.wraithxxx.symphony.ui.components.SymphonyChoiceChip
import io.github.wraithxxx.symphony.ui.components.SymphonyToggleRow
...
fun NowPlayingSleepTimerDialog(
    ...
    ScaffoldDialog(
        ...
        actions = {
            ...
            SymphonyToggleRow(
                checked = quitOnEnd,
                title = context.symphony.t.QuitAppOnEnd,
                onCheckedChange = {
                    quitOnEnd = it
            ...
            Column(modifier = Modifier.padding(top = 12.dp)) {
                Row(
                    ...
                    nowPlayingSleepTimerPresetDurations.forEach { x ->
                        ...
                        SymphonyChoiceChip(
                            text = DurationUtils.formatMinSec(0L, 0L, hours, minutes),
                            selected = inputHours == hours && inputMinutes == minutes,
                            onClick = {
                                inputHours = hours
