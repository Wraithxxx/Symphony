...
import io.github.wraithxxx.symphony.LauncherIconManager
import io.github.wraithxxx.symphony.services.i18n.CommonTranslation
...
import io.github.wraithxxx.symphony.ui.components.settings.SettingsFloatInputTile
...
import io.github.wraithxxx.symphony.ui.theme.PrimaryThemeColor
import io.github.wraithxxx.symphony.ui.theme.SymphonyTypography
import io.github.wraithxxx.symphony.ui.theme.ThemeColors
...
fun AppearanceSettingsView(context: ViewContext) {
    ...
    val useOriginalAppIcon by context.symphony.settings.useOriginalAppIcon.flow.collectAsState()
        ...
        content = { contentPadding ->
            Box(
                ...
                Column(modifier = Modifier.verticalScroll(scrollState)) {
                    ...
                    SettingsSwitchTile(
                        icon = {
                            Icon(Icons.Filled.Launch, null)
                        },
                        title = {
                            Text("Use classic icon instead?")
                        },
                        value = useOriginalAppIcon,
                        onChange = { value ->
                            context.symphony.settings.useOriginalAppIcon.setValue(value)
                            LauncherIconManager.switchIcon(context.activity, value)
                        }
                    )
                    HorizontalDivider()
                    SettingsOptionTile(
