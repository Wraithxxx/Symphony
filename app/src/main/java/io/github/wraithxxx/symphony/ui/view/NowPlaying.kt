...
import io.github.wraithxxx.symphony.services.radio.RadioPlaybackReadiness
import io.github.wraithxxx.symphony.services.radio.RadioQueue
import io.github.wraithxxx.symphony.ui.helpers.ViewContext
import io.github.wraithxxx.symphony.ui.view.nowPlaying.NothingPlaying
import io.github.wraithxxx.symphony.ui.view.nowPlaying.NowPlayingBody
...
fun NowPlayingObserver(
    ...
    val song by remember(playbackSnapshot.songId) {
        derivedStateOf {
    ...
    val data = when {
        isViable -> NowPlayingData(
            ...
            isPlayPending = playbackSnapshot.isPlayPending,
            currentSongIndex = playbackSnapshot.queueIndex,
