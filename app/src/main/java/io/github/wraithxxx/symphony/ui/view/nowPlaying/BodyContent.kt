package io.github.wraithxxx.symphony.ui.view.nowPlaying
...
import io.github.wraithxxx.symphony.ui.components.SongDropdownMenu
...
import io.github.wraithxxx.symphony.ui.view.NowPlayingData
import io.github.wraithxxx.symphony.utils.DurationUtils
...
fun NowPlayingSeekBar(context: ViewContext) {
    ...
    Row(
        ...
        var seekRatio by remember(playbackSnapshot.generation) { mutableStateOf<Float?>(null) }
...
private fun NowPlayingPlayPauseButton(
    ...
    data.run {
        NowPlayingControlButton(
            style = style,
            loading = isPlayPending && !isPlaying,
            icon = when {
