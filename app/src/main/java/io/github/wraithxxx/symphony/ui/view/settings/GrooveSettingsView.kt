...
import io.github.wraithxxx.symphony.ui.components.settings.SettingsMultiGrooveFolderTile
import io.github.wraithxxx.symphony.ui.components.settings.SettingsMultiSystemFolderTile
import io.github.wraithxxx.symphony.ui.components.settings.SettingsMultiTextOptionTile
...
import io.github.wraithxxx.symphony.ui.components.settings.SettingsTextInputTile
import io.github.wraithxxx.symphony.ui.helpers.TransitionDurations
import io.github.wraithxxx.symphony.ui.helpers.ViewContext
import io.github.wraithxxx.symphony.ui.view.SettingsViewRoute
...
private fun refreshMediaLibrary(symphony: Symphony, clearCache: Boolean = false) {
    symphony.groove.fetch(
        Groove.FetchOptions(
            force = true,
            refreshMetadata = clearCache,
        )
    )
}
