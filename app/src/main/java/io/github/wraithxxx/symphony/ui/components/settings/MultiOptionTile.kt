...
import io.github.wraithxxx.symphony.ui.components.SymphonyChoiceRow
import io.github.wraithxxx.symphony.ui.components.SymphonySelectionIndicator
                ...
                Column(
                    ...
                    sortedValues.mapIndexed { i, key ->
                        ...
                        SymphonyChoiceRow(
                            ...
                            onClick = toggleEntry,
                            trailingContent = {
                                SymphonySelectionIndicator(selected)
                                if (selected) {
                            Row(
                                ...
                                IconButton(
                                    enabled = i - 1 >= 0,
                                    onClick = { Collections.swap(nValue, i - 1, i) }
                                ) {
