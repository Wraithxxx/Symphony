    ...
    companion object {
        fun parse(
            ...
            if (symphony.settings.useMetaphony.value) {
                try {
                    val song = parseUsingMetaphony(symphony, path, file, stableId)
                    if (song != null) {
                        return song
                    }
                } catch (err: Exception) {
            ...
            return parseUsingMediaMetadataRetriever(symphony, path, file, stableId)
        }
        ...
        private fun parseUsingMetaphony(
            ...
            val id = stableId ?: symphony.groove.song.idGenerator.next()
        ...
        fun parseUsingMediaMetadataRetriever(
            ...
            val id = stableId ?: symphony.groove.song.idGenerator.next() + ".mr"
